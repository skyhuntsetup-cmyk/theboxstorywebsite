...
export default function RootLayout({
  ...
  return (
    ...
    >
      <body className="min-h-full flex flex-col bg-[#FFFDF5] text-teal-deep selection:bg-rani-pink selection:text-white">
        <GiftProvider>
          <Navbar />
          <CartDrawer />
          <main className="flex-1 pt-24">{children}</main>
          {/* Footer */}
          <footer className="bg-teal-deep text-[#FFFDF5] py-12 px-6 mt-20 border-t border-teal-deep/20">
            <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
              <div className="space-y-4">
                <span className="font-heading text-2xl font-bold">The Box Story</span>
                <p className="text-sm text-[#FFFDF5]/70 leading-relaxed">
              ...
              <div>
                ...
                <ul className="space-y-2 text-sm text-[#FFFDF5]/70">
            ...
            <div className="max-w-6xl mx-auto border-t border-[#FFFDF5]/10 mt-8 pt-6 flex flex-col sm:flex-row justify-between items-center text-xs text-[#FFFDF5]/50">
              <p>© {new Date().getFullYear()} The Box Story. All rights reserved.</p>
              <div className="flex space-x-4 mt-4 sm:mt-0">
                <span className="hover:text-[#FFFDF5] cursor-pointer">Privacy Policy</span>
                <span className="hover:text-[#FFFDF5] cursor-pointer">Terms of Service</span>
              </div>
            </div>
          </footer>
        </GiftProvider>
