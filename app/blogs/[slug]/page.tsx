      ...
      <div className="max-w-4xl mx-auto space-y-10">
        ...
        <section className="bg-white border border-slate-200 rounded-[36px] p-6 sm:p-12 shadow-sm text-left grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="md:col-span-8 space-y-4">
            <span className="text-[9px] tracking-widest font-black uppercase text-saffron bg-saffron/10 border border-saffron/15 px-3 py-1.5 rounded-full inline-block">
              {post.category}
            </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
          ...
          <aside className="lg:col-span-2 bg-white border border-slate-200 p-4 rounded-3xl space-y-4 sticky top-24 text-left shadow-sm flex flex-row lg:flex-col justify-around lg:justify-start items-center lg:items-stretch">
            <div className="hidden lg:block border-b border-slate-100 pb-2 mb-2">
              <span className="text-[9px] font-bold uppercase tracking-widest text-slate-400 block">Pin & Save</span>
            </div>
            ...
            <div className="hidden lg:block border-t border-slate-100 pt-3">
              <span className="text-[8px] font-bold text-slate-400 uppercase tracking-widest block">Pinterest Board Idea</span>
              ...
              {relatedPosts.map((related) => (
                ...
                >
                  <div className="space-y-2">
                    <span className="text-[8px] font-black text-saffron uppercase tracking-widest">
                      {related.category}
                    </span>
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-slate-100 text-[10px] font-bold text-teal-deep group-hover:text-saffron transition-colors">
