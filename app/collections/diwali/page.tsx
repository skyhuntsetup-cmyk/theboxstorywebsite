...
export default function DiwaliCollection() {
  ...
  const diwaliProducts: DiwaliProduct[] = [
    ...
    },
    {
      ...
      name: "Arpan",
      price: 1250,
      tagline: "A heartfelt offering of devotion, taste, and togetherness.",
      description: "Arpan is a soulful blend of devotion and elegance — a hamper designed to honor tradition while radiating grace. Housed in a premium leatherette see-through box, it carries handpicked elements that symbolize purity, prosperity, and spiritual light. With Ram Lala Moorti as the centerpiece, paired with natural honey and pure ghee, this hamper becomes a true offering of wellness and divinity. The brass candle and loban daan add an aromatic warmth, creating the perfect festive aura.",
      detailPage: 43,
      photoPages: [47, 48],
      inclusions: [
        "Premium decorated leatherette see-through box",
        "Ram Lala Moorti in golden finish",
        "Natural forest honey jar & Pure desi ghee jar",
        "Handcrafted brass candle & Brass loban daan",
        "Shredded Paper Base & Personalized Diwali Note"
      ],
      variants: [
        { name: "Premium Set", price: 1250 }
      ]
    },
    {
      id: "diwali-11",
      name: "Shubh Aabhar",
      price: 1300,
      tagline: "A handcrafted tray of devotion, taste, and prosperity.",
      description: "This decorated leatherette tray combines elegance with tradition, featuring handpicked festive essentials that balance taste and blessings. Designed with floral detailing and Kalash hangings, it’s a hamper that reflects abundance and joy — perfect for celebrating togetherness this festive season.",
      detailPage: 44,
      photoPages: [47, 48],
      inclusions: [
        "Decorated leatherette tray with festive detailing",
        "2 x Dry Fruit Boxes in Potli (assorted nuts)",
        "Urli (brass-finish decorative diya bowl)",
        "Honey box & Brittles box & Agarbatti pack",
        "Eat Better Sweet Crunchy Mix & 2 Kalash hangings"
      ],
      variants: [
        { name: "Premium Set", price: 1300 }
      ]
    },
    {
      id: "diwali-12",
      name: "Divya Upahar",
      price: 1450,
      tagline: "A box of blessings that carries devotion, tradition, and festive indulgence.",
      description: "The Divya Upahar is a spiritually inspired festive box that unites devotion, tradition, and nourishment. With sacred scriptures, divine idols, artisanal snacks, and handcrafted brass diyas, this hamper is designed to light up homes and hearts. Perfect as a festive offering for family, clients, and loved ones, it is a true blend of blessings and taste.",
      detailPage: 45,
      photoPages: [47, 48],
      inclusions: [
        "Decorated leatherette see-through hamper box",
        "Ganesh Chalisa & Hanuman Chalisa",
        "Golden Laxmi–Ganesh idols",
        "Eat Better Cashew, Almond & Sweet Crunchy Nut Mix packets",
        "2 Brass Auspicious Kachua Diyas & Brass Aarti Diya"
      ],
      variants: [
        { name: "Premium Set", price: 1450 }
      ]
    },
    {
      id: "diwali-13",
    ...
    },
    {
      ...
      name: "Gagan Shub",
      price: 1510,
      tagline: "A gift of elegance from the skies, filled with festive delights.",
      description: "A regal 4-jar hamper symbolizing prosperity and festivity, perfect for corporate milestones or family celebrations. Inspired by the vastness of the sky and the grace of cranes, this 4-jar luxury box blends art with tradition. The pastel sunset tones and golden accents make it perfect for corporate and personal gifting. Each jar is filled with a selection of handpicked delights, making it the perfect gift to celebrate traditions with a modern touch.",
      detailPage: 20,
      photoPages: [21, 22],
      inclusions: [
        "Reusable MDF Decorative Box with golden handle & gold foiled detailing",
        "4 Premium Jars of 200gm Dry Fruits each (options like almonds, cashews, raisins, or mixed nuts)",
        "Personalized Diwali Message Card"
      ],
      variants: [
        { name: "200gm each of Cashews, Raisins, Seeds Nuts & Berries, Almonds", price: 1510 },
        { name: "200gm each of Chocodips, Seeds Nuts & Berries Mix, Almonds & Cashews", price: 1510 },
        { name: "200gm each of Cashews, Almonds, Pistachios, Hazelnuts", price: 1830 }
      ]
    },
    {
      id: "diwali-16",
      name: "Mayur Mahal",
      price: 1510,
      tagline: "Where grandeur meets gifting.",
      description: "A luxurious 4-jar peacock-inspired box symbolizing prosperity and grandeur — ideal for festive gifting. The Mayur Mahal hamper brings together the elegance of peacock-inspired artistry with the richness of premium dry fruits. This 4-jar box is crafted like a royal treasure chest — detailed, festive, and luxurious. Each jar is filled with a selection of handpicked delights, making it the perfect gift to celebrate traditions with a modern touch.",
      detailPage: 23,
      photoPages: [24, 25, 26, 27, 28, 29, 30, 31, 32],
      inclusions: [
        "Reusable MDF Decorative Box with golden handle & gold foiled detailing",
        "4 Premium Jars of 200gm Dry Fruits each (options like almonds, cashews, raisins, or mixed nuts)",
        "Personalized Diwali Message Card"
            ...
            {diwaliProducts.map((p) => (
              ...
              >
                ...
                <div className="relative h-60 bg-teal-deep/5 overflow-hidden">
                  ...
                  <img 
                    src={`/images/diwali-catalog/page_${p.photoPages[0]}.png`} 
                    alt={p.name} 
          ...
          {selectedProduct && (
            <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
              ...
              >
                ...
                <button 
                  onClick={() => setSelectedProduct(null)}
                  className="absolute top-5 right-5 p-2 bg-white/20 hover:bg-white/30 text-teal-deep rounded-full transition-colors z-20 shadow-md"
                >
                  <X className="w-5 h-5" />
                </button>

                {/* Left Side: Product Photos Page Carousel */}
                <div className="lg:col-span-6 bg-white p-6 sm:p-10 flex flex-col justify-center items-center border-r border-teal-deep/10 max-h-[92vh] overflow-hidden relative group">
                  <div className="w-full h-full relative rounded-2xl overflow-hidden shadow-md aspect-[1/1.2] flex items-center justify-center">
                    {/* eslint-disable-next-line @next/next/no-img-element */}
                    <img 
                      src={`/images/diwali-catalog/page_${selectedProduct.photoPages[activePhotoIdx]}.png`} 
                      alt={`${selectedProduct.name} Photo ${activePhotoIdx + 1}`} 
                    ...
                    {selectedProduct.photoPages.length > 1 && (
                      <>
                        <button
                          onClick={() => setActivePhotoIdx((prev) => (prev > 0 ? prev - 1 : selectedProduct.photoPages.length - 1))}
                          className="absolute left-3 p-2 bg-teal-deep/10 hover:bg-teal-deep/20 text-teal-deep rounded-full transition-colors flex items-center justify-center"
                        >
                          <ArrowLeft className="w-4 h-4" />
                        </button>
                        <button
                          onClick={() => setActivePhotoIdx((prev) => (prev < selectedProduct.photoPages.length - 1 ? prev + 1 : 0))}
                          className="absolute right-3 p-2 bg-teal-deep/10 hover:bg-teal-deep/20 text-teal-deep rounded-full transition-colors flex items-center justify-center"
                        >
                      ...
                      {selectedProduct.photoPages.map((_: number, idx: number) => (
                        <button
                          ...
                          className={`w-2 h-2 rounded-full transition-all ${
                            idx === activePhotoIdx ? "bg-saffron w-4" : "bg-teal-deep/20 hover:bg-teal-deep/40"
                          }`}
                        />
                      ))}
                    </div>
                  ...
                  <AnimatePresence>
                    {isFaqActive && (
                      <motion.div
                        ...
                        className="border-t border-teal-deep/5 bg-[#FCFAF2]/50 p-5 text-xs text-slate-650 leading-relaxed"
                      >
                        {faq.a}
                      </motion.div>
                    )}
