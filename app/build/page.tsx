                  ...
                  return (
                    <button
                      ...
                      className={`p-4 rounded-2xl border text-left transition-all duration-300 bg-gradient-to-br ${
                        style.color || "from-amber-50 to-amber-100/50 border-amber-200"
                      } ${
                        isSelected
                  ...
                  return (
                    ...
                    >
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="text-xs font-semibold text-slate-800">{style.name}</span>
                      </div>
          ...
          <div className="lg:col-span-5 sticky top-24 space-y-6">
            <div className="bg-white border border-slate-200 p-6 sm:p-8 space-y-6 shadow-md rounded-[40px]">
              ...
              <button
                ...
                className="w-full flex items-center justify-center space-x-2 py-4 bg-teal-deep text-white hover:bg-teal-deep/90 rounded-xl font-bold text-sm shadow-md disabled:opacity-30 disabled:hover:bg-teal-deep transition-all transform hover:-translate-y-0.5"
              >
