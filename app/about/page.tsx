...
import { Heart, Sparkles, Box, Users, Award, ShieldCheck } from "lucide-react";
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8 space-y-24 text-left">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        ...
        <div className="relative aspect-[4/3] rounded-3xl overflow-hidden bg-teal-deep/5 border border-teal-deep/5 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {values.map((val, idx) => (
            ...
            >
              ...
              <p className="text-xs text-teal-deep/60 leading-relaxed">{val.desc}</p>
            </div>
          ))}
        </div>
      </section>
